...
<?php get_header() ?>
	...
	<div id="sidebar">
		<h2>В момента</h2><ul><li><p>... търсиш из архивите <strong>'<?php echo $s; ?>'</strong>. Ако не можеш да откриеш нищо (даже еднорози :(), не се отчайвай, погледни из някоя от връзките встрани или направо ни пиши. Търси, Приятеле, търси! (На Шмендрик за стиха благодари. :D)</p></li></ul>
		<?php get_sidebar(); ?>
	</div>
<?php get_footer(); ?>
</div>
